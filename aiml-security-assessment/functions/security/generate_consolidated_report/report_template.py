...
<body>
    <div class="layout">
        ...
        <main class="main">
            <section id="overview" class="section">
                ...
                <div class="metrics">
                    <div class="metric"><div class="metric-label">Total Checks</div><div class="metric-value">{total_checks}</div><div class="metric-sub">Across all services</div></div>
            ...
            <section id="methodology" class="section">
                ...
                <div class="card"><div class="card-header"><h3>Severity Levels</h3></div><div class="card-body"><table style="width: 100%; font-size: 13px;"><tbody><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top; border-bottom: 1px solid var(--border);"><span class="severity high">High</span></td><td style="padding: 8px 0; color: var(--text-2); border-bottom: 1px solid var(--border);">Direct security risk requiring immediate remediation</td></tr><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top; border-bottom: 1px solid var(--border);"><span class="severity medium">Medium</span></td><td style="padding: 8px 0; color: var(--text-2); border-bottom: 1px solid var(--border);">Defense-in-depth gap with indirect exposure</td></tr><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top; border-bottom: 1px solid var(--border);"><span class="severity low">Low</span></td><td style="padding: 8px 0; color: var(--text-2); border-bottom: 1px solid var(--border);">Best practice recommendation</td></tr><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top;"><span class="severity na">Informational</span></td><td style="padding: 8px 0; color: var(--text-2);">No action required</td></tr></tbody></table></div></div>
                <div class="card"><div class="card-header"><h3>Status Values</h3></div><div class="card-body"><table style="width: 100%; font-size: 13px;"><tbody><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top; border-bottom: 1px solid var(--border);"><span class="status error">Failed</span></td><td style="padding: 8px 0; color: var(--text-2); border-bottom: 1px solid var(--border);">Issue found, remediation needed</td></tr><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top; border-bottom: 1px solid var(--border);"><span class="status success">Passed</span></td><td style="padding: 8px 0; color: var(--text-2); border-bottom: 1px solid var(--border);">Configuration meets requirements</td></tr><tr><td style="padding: 8px 16px 8px 0; white-space: nowrap; vertical-align: top;"><span class="status warning">N/A</span></td><td style="padding: 8px 0; color: var(--text-2);">Check not applicable or no resources</td></tr></tbody></table></div></div>
                <div class="card"><div class="card-header"><h3>Remediation Guidance</h3></div><div class="card-body"><table style="width: 100%; font-size: 13px;"><thead><tr style="text-align: left; border-bottom: 2px solid var(--border);"><th style="padding: 8px 12px; font-weight: 600; color: var(--text);">Priority</th><th style="padding: 8px 12px; font-weight: 600; color: var(--text);">Timeline</th><th style="padding: 8px 12px; font-weight: 600; color: var(--text);">Approach</th></tr></thead><tbody><tr style="border-bottom: 1px solid var(--border);"><td style="padding: 8px 12px;"><span class="severity high">High</span></td><td style="padding: 8px 12px; color: var(--text-2);">7 days</td><td style="padding: 8px 12px; color: var(--text-2);">Address immediately; block deployment if unresolved</td></tr><tr style="border-bottom: 1px solid var(--border);"><td style="padding: 8px 12px;"><span class="severity medium">Medium</span></td><td style="padding: 8px 12px; color: var(--text-2);">30 days</td><td style="padding: 8px 12px; color: var(--text-2);">Schedule in next sprint; may require change window</td></tr><tr><td style="padding: 8px 12px;"><span class="severity low">Low</span></td><td style="padding: 8px 12px; color: var(--text-2);">90 days</td><td style="padding: 8px 12px; color: var(--text-2);">Include in backlog; address during regular maintenance</td></tr></tbody></table><p style="color: var(--text-3); font-size: 12px; margin-top: 12px;">Within same severity, prioritize by affected resource count. Production accounts may warrant elevated treatment.</p></div></div>
                <div class="card"><div class="card-header"><h3>Assessment Notes</h3></div><div class="card-body"><table style="width: 100%; font-size: 13px;"><tbody><tr style="border-bottom: 1px solid var(--border);"><td style="padding: 8px 0; width: 140px; font-weight: 500; color: var(--text);">Point-in-time</td><td style="padding: 8px 0; color: var(--text-2);">Security posture changes as resources are modified. Regular reassessment recommended.</td></tr><tr style="border-bottom: 1px solid var(--border);"><td style="padding: 8px 0; font-weight: 500; color: var(--text);">Scope limited</td><td style="padding: 8px 0; color: var(--text-2);">Passed checks verify tested controls only, not complete security coverage.</td></tr><tr><td style="padding: 8px 0; font-weight: 500; color: var(--text);">Context matters</td><td style="padding: 8px 0; color: var(--text-2);">Severity based on general best practices. Adjust for compliance requirements and environment type.</td></tr></tbody></table></div></div>
    ...
    <script>
        ...
        function createServiceFilter(tableId, searchId, severityId, statusId, resetId) {{
        ...
        createServiceFilter('bedrockTable', 'bedrockSearchInput', 'bedrockSeverityFilter', 'bedrockStatusFilter', 'bedrockResetFilters');
        createServiceFilter('sagemakerTable', 'sagemakerSearchInput', 'sagemakerSeverityFilter', 'sagemakerStatusFilter', 'sagemakerResetFilters');
        createServiceFilter('agentcoreTable', 'agentcoreSearchInput', 'agentcoreSeverityFilter', 'agentcoreStatusFilter', 'agentcoreResetFilters');
    </script>
</body>
</html>'''
...
def generate_html_report(
    ...
    """
    # Calculate metrics
    total_checks = len(all_findings)  # All findings including N/A for table display
